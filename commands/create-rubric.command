#!/usr/bin/env bash
# Creates a Canvas rubric. Settings: create-rubric.config.jsonc. Requires
...
launch "$OUT_DIR" -- "$ENGINE/.venv/bin/canvas-automation" create-rubric --engine "$ENGINE" --config "$CONFIG"
