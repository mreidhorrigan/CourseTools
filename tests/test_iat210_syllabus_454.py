...
def test_transform_is_idempotent_and_aligns_sequence_and_quizzes():
    ...
    assert [r[0] for r in rows][1:4]==["Actual-play podcast and tabletop roleplay","Digital game design: procedural ecosystem","Board-game design"]
